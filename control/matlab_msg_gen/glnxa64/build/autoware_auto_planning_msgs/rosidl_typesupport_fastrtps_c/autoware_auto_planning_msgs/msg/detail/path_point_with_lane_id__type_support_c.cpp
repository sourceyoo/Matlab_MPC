...
bool cdr_serialize_autoware_auto_planning_msgs__msg__PathPoint(
  const autoware_auto_planning_msgs__msg__PathPoint * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_autoware_auto_planning_msgs__msg__PathPoint(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_planning_msgs__msg__PathPoint * ros_message);
...
bool cdr_serialize_key_autoware_auto_planning_msgs__msg__PathPoint(
  const autoware_auto_planning_msgs__msg__PathPoint * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_autoware_auto_planning_msgs__msg__PathPoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_autoware_auto_planning_msgs__msg__PathPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: point
  {
    cdr_serialize_autoware_auto_planning_msgs__msg__PathPoint(
  ...
  autoware_auto_planning_msgs__msg__PathPointWithLaneId * ros_message)
{
  // Field name: point
  {
    cdr_deserialize_autoware_auto_planning_msgs__msg__PathPoint(cdr, &ros_message->point);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: point
  {
    cdr_serialize_key_autoware_auto_planning_msgs__msg__PathPoint(
      &ros_message->point, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: point
  current_alignment += get_serialized_size_key_autoware_auto_planning_msgs__msg__PathPoint(
    &(ros_message->point), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_autoware_auto_planning_msgs__msg__PathPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const autoware_auto_planning_msgs__msg__PathPointWithLaneId * ros_message = static_cast<const autoware_auto_planning_msgs__msg__PathPointWithLaneId *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_autoware_auto_planning_msgs__msg__PathPointWithLaneId(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  autoware_auto_planning_msgs__msg__PathPointWithLaneId * ros_message = static_cast<autoware_auto_planning_msgs__msg__PathPointWithLaneId *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_autoware_auto_planning_msgs__msg__PathPointWithLaneId(cdr, ros_message);
}
