  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_planning_msgs__msg__TrajectoryPoint;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const autoware_auto_planning_msgs__msg__TrajectoryPoint * ros_message = static_cast<const autoware_auto_planning_msgs__msg__TrajectoryPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_autoware_auto_planning_msgs__msg__TrajectoryPoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  autoware_auto_planning_msgs__msg__TrajectoryPoint * ros_message = static_cast<autoware_auto_planning_msgs__msg__TrajectoryPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_autoware_auto_planning_msgs__msg__TrajectoryPoint(cdr, ros_message);
}
...
static size_t _TrajectoryPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_auto_planning_msgs__msg__TrajectoryPoint(
