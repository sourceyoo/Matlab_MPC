  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const autoware_auto_planning_msgs__msg__PathPoint * ros_message = static_cast<const autoware_auto_planning_msgs__msg__PathPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_autoware_auto_planning_msgs__msg__PathPoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  autoware_auto_planning_msgs__msg__PathPoint * ros_message = static_cast<autoware_auto_planning_msgs__msg__PathPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_autoware_auto_planning_msgs__msg__PathPoint(cdr, ros_message);
}
