  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xb2, 0x74, 0x76, 0x6b, 0xda, 0x20, 0xaa, 0xfe,
      0x2c, 0xaf, 0xef, 0x83, 0x5b, 0x74, 0xdb, 0x3f,
      0xc9, 0xc3, 0x19, 0x10, 0xdf, 0xae, 0xb4, 0x29,
      0xab, 0x7c, 0x12, 0xb7, 0x04, 0x63, 0xae, 0x0f,
    }};
  return &hash;
}
...
static char autoware_auto_planning_msgs__msg__Path__TYPE_NAME[] = "autoware_auto_planning_msgs/msg/Path";
...
static char autoware_auto_planning_msgs__msg__Path__FIELD_NAME__header[] = "header";
static char autoware_auto_planning_msgs__msg__Path__FIELD_NAME__points[] = "points";
static char autoware_auto_planning_msgs__msg__Path__FIELD_NAME__left_bound[] = "left_bound";
static char autoware_auto_planning_msgs__msg__Path__FIELD_NAME__right_bound[] = "right_bound";

static rosidl_runtime_c__type_description__Field autoware_auto_planning_msgs__msg__Path__FIELDS[] = {
  {
    {autoware_auto_planning_msgs__msg__Path__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {autoware_auto_planning_msgs__msg__Path__FIELD_NAME__points, 6, 6},
    {
  ...
  {
    {autoware_auto_planning_msgs__msg__Path__FIELD_NAME__left_bound, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {autoware_auto_planning_msgs__msg__Path__FIELD_NAME__right_bound, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription autoware_auto_planning_msgs__msg__Path__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {autoware_auto_planning_msgs__msg__PathPoint__TYPE_NAME, 41, 41},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {autoware_auto_planning_msgs__msg__Path__TYPE_NAME, 36, 36},
      {autoware_auto_planning_msgs__msg__Path__FIELDS, 4, 4},
    },
    {autoware_auto_planning_msgs__msg__Path__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "autoware_auto_planning_msgs/PathPoint[] points\n"
...
autoware_auto_planning_msgs__msg__Path__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *autoware_auto_planning_msgs__msg__Path__get_individual_type_description_source(NULL),
