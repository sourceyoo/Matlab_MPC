...
// IWYU pragma: private, include "autoware_auto_planning_msgs/msg/trajectory.hpp"
...
struct Trajectory_
{
  ...
  _header_type header;
  using _points_type =
    std::vector<autoware_auto_planning_msgs::msg::TrajectoryPoint_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_auto_planning_msgs::msg::TrajectoryPoint_<ContainerAllocator>>>;
  _points_type points;
  ...
  Type & set__points(
    const std::vector<autoware_auto_planning_msgs::msg::TrajectoryPoint_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_auto_planning_msgs::msg::TrajectoryPoint_<ContainerAllocator>>> & _arg)
  {
    this->points = _arg;
    return *this;
  }
